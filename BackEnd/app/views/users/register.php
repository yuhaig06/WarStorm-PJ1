...
<body>
    <div class="container">
        <div class="form-box" id="register-box">
            ...
            <form id="registerForm" method="POST" action="/PJ1/BackEnd/public/users/register">
                ...
                <p class="switch-form">Đã có tài khoản? <a href="/PJ1/BackEnd/public/users/login">Đăng nhập</a></p>
            </form>
        </div>
    </div>
    <script>
