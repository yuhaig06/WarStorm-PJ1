    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                <div class="error-box">
                    <h1 class="error-code" style="color:#1ea7fd">500</h1>
                    <h2 class="error-title">Lỗi máy chủ</h2>
                    <p class="error-message">Đã có lỗi xảy ra ở phía máy chủ.<br>Vui lòng thử lại sau hoặc liên hệ admin nếu lỗi vẫn tiếp tục.</p>
